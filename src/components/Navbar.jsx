        ...
        <div className="flex h-16 items-center justify-between lg:grid lg:grid-cols-[1fr_auto_1fr] lg:gap-2">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <h1 className="text-base font-bold tracking-wide sm:text-xl text-slate-900 dark:text-white">
              <span 
                className="bg-gradient-to-r from-yellow-400 via-slate-500 to-white bg-[length:200%_auto] bg-clip-text text-transparent"
          ...
          {/* Desktop Right */}
          <div className="hidden items-center justify-end gap-3 lg:flex min-w-[200px]">
            <ThemeToggle />

            {isPending ? (
              <div className="w-[150px] h-8 flex items-center justify-center">
                  ...
                  <>
                    ...
                    <div className="absolute right-0 z-50 mt-2 w-48 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl dark:border-white/10 dark:bg-[#0f172a]">
                      <button
                        ...
                        className="flex w-full items-center gap-2 px-4 py-3 text-sm text-gray-700 transition hover:bg-yellow-400 hover:text-black dark:text-gray-200 dark:hover:bg-yellow-400/20"
                      >
                      ...
                      <button
                        ...
                        className="flex w-full items-center gap-2 px-4 py-3 text-sm text-red-500 transition hover:bg-red-50 hover:text-red-600 dark:text-red-400 dark:hover:bg-red-500/10"
                      >
              ...
              <div className="flex items-center gap-2">
                <Link href="/login">
                  <button
                    type="button"
                    className="flex items-center gap-1 rounded-full border border-yellow-400 px-4 py-2 text-sm font-semibold text-yellow-600 transition hover:bg-yellow-400 hover:text-black dark:text-yellow-400 dark:hover:bg-yellow-400/20"
                  >
                    <BiLogIn />
                    Login
                  </button>
                ...
                <Link href="/signup">
                  <button
                    type="button"
                    className="rounded-full bg-gradient-to-r from-yellow-400 to-gray-400 hover:opacity-90 px-4 py-2 text-sm font-semibold text-[#081224] transition"
                  >
                    Get started
                  </button>
                </Link>
            ...
            {isPending ? (
              ...
              <div className="flex items-center gap-1">
                <Link href="/login">
                  <button
                    type="button"
                    className="flex items-center gap-1 rounded-full border border-yellow-400 px-3 py-1.5 text-xs font-semibold text-yellow-600 dark:text-yellow-400 dark:hover:bg-yellow-400/10"
                  >
                    <BiLogIn />
                    Login
                  </button>
                ...
                <Link href="/signup">
                  <button
                    type="button"
                    className="rounded-full bg-gradient-to-r from-yellow-400 to-gray-400 px-3 py-1.5 text-xs font-semibold text-[#081224] hover:opacity-90"
                  >
                    Get started
                  </button>
                </Link>
                  ...
                  <button
                    ...
                    className={`flex w-full items-center gap-3 px-4 py-3.5 text-sm transition ${
                      item.action === "logout"
                        ...
                        : "text-gray-700 hover:bg-yellow-400 hover:text-black dark:text-gray-200 dark:hover:bg-yellow-400/20"
                    }`}
                  >
                    <item.icon className="text-lg text-yellow-500 dark:text-yellow-400" />
                    {item.label}
