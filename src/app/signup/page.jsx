...
const SignupPage = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center p-5 sm:p-8 relative">
      ...
      <Link
        href="/"
        className="absolute top-6 font-bold left-6 flex items-center gap-2 px-4 py-2.5 bg-linear-to-r from-yellow-400 to-gray-400 hover:opacity-90 backdrop-blur-md border border-[#1A1A1A]/10 rounded-full shadow-sm text-[#1A1A1A]/80 hover:text-[#1A1A1A] hover:border-yellow-500 transition-all text-sm "
      >
      ...
      <div className="w-full max-w-md bg-[#FAF9F6] rounded-3xl shadow-xl shadow-[#1A1A1A]/8 p-8 sm:p-10 ring-1 ring-[#1A1A1A]/[0.06]">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-1.5 rounded-2xl border border-[#1A1A1A]/12 outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500/20 transition-all bg-[#FAF9F6] text-[#1A1A1A] placeholder:text-[#1A1A1A]/35"
            />
          </div>
        ...
        <div className="grid grid-cols-1 gap-3 mb-2">
          <button onClick={handleGoogleLogin}
            type="button"
            className="flex hover:border-yellow-500 hover:ring-2 hover:ring-yellow-500/20 items-center cursor-pointer justify-center gap-2 py-3 border border-[#1A1A1A]/12 rounded-2xl hover:bg-[#1A1A1A]/10 transition-colors text-sm font-semibold text-[#1A1A1A]/80"
          >
            <FcGoogle size={20} />
            Google
          </button>
