        ...
        <div className="min-h-screen flex items-center justify-center bg-[#FAF9F6] px-6 py-16">
            <div className="text-center max-w-lg">
                ...
                <div className="relative inline-block -mt-4 mb-8">
                    <span className="inline-block px-4 py-2 text-xs font-semibold uppercase tracking-widest bg-yellow-500 text-white rounded-full shadow-lg shadow-yellow-500/25 rotate-[-3deg]">
                        Page Not Found
                    </span>
                </div>
