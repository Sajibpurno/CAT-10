'use client';
import { FieldError,Select, Input, Label, ListBox, TextField, Button, TextArea } from '@heroui/react';


const AddCatInfoForm = () => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="md:col-span-2">
      <TextField name="petImageUrl">
        <Label>Pet Image URL <span className="text-sm font-normal text-gray-400">(upload to imgbb.com first)</span></Label>
        <Input
          type="url"
    ...
    <div className="md:col-span-2">
      <TextField name="ownerEmail" type="email">
        ...
        <Input
          type="email"
          placeholder="123arafat@gmail.com"
          className="rounded-2xl"
        />
        <FieldError />
      </TextField>
